...
import { interval, throwError, of, concat, Observable } from 'rxjs';
import { takeUntil, retryWhen, count, retry, flatMap, delay, take, concatMap, catchError} from 'rxjs/operators';
...
export class HomePage implements OnInit {
  ...
  // private HealthProviders:HealthProvider[]=[
  //   {
  //     _id:'doctor',
  //     providerName:'doctor'
  //   },
  ...
  //   {
  //     _id:'medical-store',
  //     providerName:'medical-store'
  //   },
  //   {
  //     _id:'transport-service',
  //     providerName:'transport-service'
  //   },
  //   {
  //     _id:'dentist',
  ...
  ionViewWillEnter(){
    ...
    // this.serviceProviders=this.HealthProviders;
    // for(let i=0;i<this.serviceProviders.length;i++){
    //   this.serviceProviders[i].icon=this.icons[i]
    //   this.serviceProviders[i].providerName=this.HealthProviders[i].providerName.toLowerCase()
    //   .replace("-"," ").split(" ")
